...
\begin{document}
  ...
  \begin{frame}{Перспективы и риски}
    ...
    \begin{itemize}
      % TODO ???
      \item Несовместимость с устаревшими GPU
        \par{
          \scriptsize
          --- добавление режима совместимости, не использующего GPU
        }
      \item Консервативность потребителей
        \par{
          \scriptsize
          --- демонстрация, реклама, опытное апробирование
        }
      \item Интеллектуальная собственность
        \par{
          \scriptsize
          --- регистрация авторских свидетельств на ПО и алгоритм
        }
    \end{itemize}
  \end{frame}
